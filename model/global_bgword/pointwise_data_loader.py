...
@model("global_bgword", MetaType.DataLoader)
class PointwiseModelDataLoader(loader_base.DataLoader):
    ...
    def required_fields(self):
        ...
        field_names = [self._arch_config.model_config.all_fields.index(str(x)) for x in field_names] # only applies CSVDataSource
        return field_names
